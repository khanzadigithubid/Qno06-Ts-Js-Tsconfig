/*Q6. Stripping Names: Store a person’s name, and include some whitespace characters at the
...
console.log("mynameisKhanzadi");
console.log("my\tname\tis\tKhanzadi");  //used for spaces b/w words.
console.log("my\nname\nis\nKhanzadi"); //used for next lines.